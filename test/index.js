...
describe("API ENDPOINT TESTING", () => {
    ...
    it("GET Detail Page", (done) => {
        chai.request(app)
            .get("/api/v1/member/detail-page/5e96cbe292b97300fc902229")
            .end((err, res) => {
                expect(err).to.be.null;
                expect(res).to.have.status(200);
                expect(res.body).to.be.an("Object");
    ...
    it("POST Booking Page", (done) => {
        ...
        const dataSample = {
            ...
            duration: 2,
            bookingStartDate: "2021-08-20T14:07:03.382Z",
            bookingEndDate: "2021-08-22T14:07:03.382Z",
            firstName: "Ryan",
            lastName: "Aprianto",
            email: "Ryan.Aprianto77777@gmail.com",
            phoneNumber: "089639626048",
            accountHolder: "Ryan",
            bankFrom: "BCA",
        };
        chai.request(app)
